...
<tr>
    ...
    <td class="buttons" colspan="3">
        <button type="submit" tabindex="%tabindex%" class="large awesome">%submit%</button>
    </td>
...
<tr>
    <td valign="top" colspan="2">
        <label for="%name%">%label% %isrequired%</label><br />
        <input name="%name%" id="%name%" class="%class% %haserror%" type="text" value="%value%" size="%size%" readonly="readonly" style="%style%" tabindex="%tabindex%" %extra% />
       %error%           
    </td>
</tr>
EOM;
...
<tr>
    <td valign="top" colspan="2">
        <label for="%name%">%label% %isrequired%</label><br />
        <input name="%name%" id="%name%" class="%class% %haserror%" type="password" value="%value%" size="%size%" style="%style%" tabindex="%tabindex%" %extra% />
       %error%           
    </td>
</tr>
EOM;
