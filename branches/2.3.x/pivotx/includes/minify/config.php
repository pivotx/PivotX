...
/** 
 * Setting the PivotX specific document root for Minify
 */
$min_documentRoot = dirname(dirname(dirname(dirname(__FILE__))));
 ...
 */
$min_cachePath = $min_documentRoot . '/pivotx/db/cache/';
