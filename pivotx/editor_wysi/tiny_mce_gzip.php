 ...
 */
    ...
    $cachePath = realpath("../db/cache/"); // Cache path, this is where the .gz files will be stored
    ...
    */);
    ...
    if ($diskCache) {
        ...
        // We include the tinyMCE build in here, to make sure that every new build has a new file..
        // Otherwise TinyMCE might get confused about the cache it uses.
        $cacheKey = substr(md5($build.$cacheKey),0,10);
