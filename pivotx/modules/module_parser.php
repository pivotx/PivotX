...
<rsd version="1.0" xmlns="http://archipelago.phrasewise.com/rsd">
    ...
    function parseTemplate($template) {
        ...
        if ($PIVOTX['config']->get('dont_add_canonical')==0) {
            ...
            // Canonical link always the same as URL?
            if (!isset($this->modifier['canonical_link']) && $PIVOTX['config']->get('canonical_always_url')==1 ) {
                // is there already a function that gets it and can be used here?
                $pageURL = 'http';
