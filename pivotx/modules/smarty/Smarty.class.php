...
// PivotX: Set this to true, to suppress debug error messages caused by old-fashioned tags.
$suppress_pivotx_errors = true;
 ...
 */
    ...
    {
        // Changes for PivotX: Do not 'die with error', but log the error and
        // return it, so the user will see what's going on. 
        debug("Smarty error: $error_msg: $error_type");
        echo stripslashes("Smarty error: $error_msg: $error_type");
   ...
   /**
            ...
            $file = null, $line = null, $error_type = E_USER_ERROR)
    {
        ...
        debug(sprintf("[smarty] %s - file: %s, line %s", $error_msg, $this->_current_file, $this->_current_line_no ));

        // PivotX: Suppress errors caused by old fashioned template tags.
        global $suppress_pivotx_errors;
        if ($suppress_pivotx_errors && ( strpos($error_msg, 'invalid attribute name') > 0 ||
            strpos($error_msg, 'after attribute name') > 0 ) ) {
            return "";
        }
