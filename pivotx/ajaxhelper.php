...
class ajaxhelper {
    ...
    public static function ext_view() {
        ...
        if ($contents = loadSerialize($filename)) {
            ...
            echo "<input type='hidden' value='".htmlspecialchars($_GET['basedir'], ENT_QUOTES)."' id='editBasedir'>";
            echo "<input type='hidden' value='".htmlspecialchars($_GET['file'], ENT_QUOTES)."' id='editFile'>";
