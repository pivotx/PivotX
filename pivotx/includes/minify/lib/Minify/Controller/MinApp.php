...
class Minify_Controller_MinApp extends Minify_Controller_Base {
    ...
    public function setupSources($options) {
        ...
        if (isset($_GET['g'])) {
            ...
            foreach ($files as $org_file) {
                $path = $_SERVER['DOCUMENT_ROOT'] . $base . $org_file;
                       
                $file = realpath($path);
                
                // Added for PivotX: fallback, be a bit more tolerant about DOCUMENT_ROOT.
                if (false === $file) {
                    $path = dirname($_SERVER['DOCUMENT_ROOT']) . $base . $org_file;
